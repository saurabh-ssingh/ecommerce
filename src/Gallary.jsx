        ...
        <>
            ...
            <div className="menu-tabs container">
                <div className="menu-tab d-flex justify-content-around">
                    ...
                    <button className="btn btn-warning" onClick={() => filterItem('furniture')}>Furniture</button>
                    <button className="btn btn-warning" onClick={() => filterItem('toys')}>Toys</button>
                    <button className="btn btn-warning" onClick={() => filterItem('grocery')}>Grocery</button>
